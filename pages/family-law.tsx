          ...
          <div className="relative">
            ...
            <div className="flex flex-col md:flex-row items-center justify-between gap-12 md:gap-0">
              {[
                {
                  icon: (
                    <svg xmlns="http://www.w3.org/2000/svg" className="w-10 h-10 text-blue-700 dark:text-blue-200" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
            ...
            <div className="space-y-16 ml-12">
              ...
              <div className="relative flex items-start gap-6">
                <div className="flex-shrink-0 w-16 h-16 rounded-full bg-blue-200 dark:bg-blue-900 flex items-center justify-center border-4 border-blue-100 dark:border-blue-800 shadow-lg">
                  <svg xmlns="http://www.w3.org/2000/svg" className="w-8 h-8 text-blue-700 dark:text-blue-200" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
