...
const LitigationDisputeResolution = () => {
  ...
  return (
    <>
      <Head>
        <title>{t("litigation.title")}</title>
        <meta name="description" content={t("litigation.metaDescription")} />
      </Head>
      <main className="bg-white dark:bg-gray-900">
              ...
              {[
                {
                  ...
                  title: t("litigation.services.0.title"),
                  desc: t("litigation.services.0.desc"),
                },
                {
                  icon: (
                    <svg
                  ...
                  title: t("litigation.services.1.title"),
                  desc: t("litigation.services.1.desc"),
                },
                {
                  icon: (
                    <svg
                  ...
                  title: t("litigation.services.2.title"),
                  desc: t("litigation.services.2.desc"),
                },
                {
                  icon: (
                    <svg
                  ...
                  title: t("litigation.services.3.title"),
                  desc: t("litigation.services.3.desc"),
                },
                {
                  icon: (
                    <svg
                  ...
                  title: t("litigation.services.4.title"),
                  desc: t("litigation.services.4.desc"),
                },
                {
                  icon: (
                    <svg
                  ...
                  title: t("litigation.services.5.title"),
                  desc: t("litigation.services.5.desc"),
                },
              ].map((item, idx) => (
                <div
                  key={item.title}
          ...
          <div className="max-w-6xl mx-auto">
            ...
            <div className="flex flex-col md:flex-row items-center justify-center gap-10 md:gap-8">
              ...
              <div className="flex-1 min-w-[260px] bg-white dark:bg-gray-900 rounded-3xl shadow-xl p-10 flex flex-col items-center text-center border-2 border-blue-400 dark:border-blue-700 relative hover:-translate-y-4 hover:shadow-2xl hover:shadow-blue-200/40 dark:hover:shadow-blue-900/40 transition-all duration-300">
                ...
                <h4 className="font-bold mb-2 text-blue-800 dark:text-blue-100 text-xl tracking-wide">
                  {t("litigation.whyChoose.1.title")}
                </h4>
                <p className="text-gray-700 dark:text-gray-300 text-center text-base">
                  {t("litigation.whyChoose.1.desc")}
                </p>
              </div>
              {/* Card 3 */}
              <div className="flex-1 min-w-[260px] bg-white dark:bg-gray-900 rounded-3xl shadow-xl p-10 flex flex-col items-center text-center border-2 border-blue-400 dark:border-blue-700 relative hover:-translate-y-4 hover:shadow-2xl hover:shadow-blue-200/40 dark:hover:shadow-blue-900/40 transition-all duration-300">
                ...
                <h4 className="font-bold mb-2 text-blue-800 dark:text-blue-100 text-xl tracking-wide">
                  {t("litigation.whyChoose.2.title")}
                </h4>
                <p className="text-gray-700 dark:text-gray-300 text-center text-base">
                  {t("litigation.whyChoose.2.desc")}
                </p>
              </div>
            </div>
          </div>
        ...
        <section className="mx-auto py-16 px-4">
          <h2 className="text-3xl font-bold text-blue-900 dark:text-blue-200 mb-14 text-center">
            {t("litigation.successStoriesTitle")}
          </h2>
          <div className="relative">
            ...
            <div className="space-y-16 ml-12">
              ...
              <div className="relative flex items-start gap-6">
                ...
                <div className="bg-white dark:bg-gray-900 rounded-2xl shadow-xl p-8 border border-blue-100 dark:border-blue-900 flex-1">
                  <p className="text-lg text-blue-900 dark:text-blue-100 mb-2 font-medium">
                    {t("litigation.successStories.0.quote")}
                  </p>
                  <div className="flex items-center gap-3 mt-4">
                    <span className="w-10 h-10 rounded-full bg-blue-300 dark:bg-blue-800 flex items-center justify-center text-xl font-bold text-blue-900 dark:text-blue-100">
                      {t("litigation.successStories.0.initials")}
                    </span>
                    <span className="text-blue-700 dark:text-blue-300 font-semibold">
                      {t("litigation.successStories.0.client")}
                    </span>
                  </div>
                </div>
              </div>
              ...
              <div className="relative flex items-start gap-6">
                ...
                <div className="bg-white dark:bg-gray-900 rounded-2xl shadow-xl p-8 border border-blue-100 dark:border-blue-900 flex-1">
                  <p className="text-lg text-blue-900 dark:text-blue-100 mb-2 font-medium">
                    {t("litigation.successStories.1.quote")}
                  </p>
                  <div className="flex items-center gap-3 mt-4">
                    <span className="w-10 h-10 rounded-full bg-blue-300 dark:bg-blue-800 flex items-center justify-center text-xl font-bold text-blue-900 dark:text-blue-100">
                      {t("litigation.successStories.1.initials")}
                    </span>
                    <span className="text-blue-700 dark:text-blue-300 font-semibold">
                      {t("litigation.successStories.1.client")}
                    </span>
                  </div>
                </div>
              </div>
        ...
        {/* Section 5: Our Litigation Process */}
        <section className="bg-blue-50 dark:bg-gray-800 py-20 px-4">
          <div className="max-w-6xl mx-auto">
            ...
            <div className="flex flex-col md:flex-row items-stretch justify-between gap-10 md:gap-6">
              {/* Step 1 */}
              <div className="flex-1 min-w-[240px] max-w-[280px] h-[300px] bg-white dark:bg-gray-900 rounded-2xl shadow-xl p-8 flex flex-col items-center text-center border-2 border-blue-200 dark:border-blue-800 relative hover:-translate-y-2 hover:shadow-2xl transition-all duration-300 mx-auto">
                ...
                <h4 className="font-bold mb-2 text-blue-800 dark:text-blue-100 text-lg tracking-wide">
                  {t("litigation.process.0.title")}
                </h4>
                <p className="text-gray-700 dark:text-gray-300 text-base">
                  {t("litigation.process.0.desc")}
                </p>
              </div>
              {/* Step 2 */}
              <div className="flex-1 min-w-[240px] max-w-[280px] h-[300px] bg-white dark:bg-gray-900 rounded-2xl shadow-xl p-8 flex flex-col items-center text-center border-2 border-blue-200 dark:border-blue-800 relative hover:-translate-y-2 hover:shadow-2xl transition-all duration-300 mx-auto">
                ...
                <h4 className="font-bold mb-2 text-blue-800 dark:text-blue-100 text-lg tracking-wide">
                  {t("litigation.process.1.title")}
                </h4>
                <p className="text-gray-700 dark:text-gray-300 text-base">
                  {t("litigation.process.1.desc")}
                </p>
              </div>
              {/* Step 3 */}
              <div className="flex-1 min-w-[240px] max-w-[280px] h-[300px] bg-white dark:bg-gray-900 rounded-2xl shadow-xl p-8 flex flex-col items-center text-center border-2 border-blue-200 dark:border-blue-800 relative hover:-translate-y-2 hover:shadow-2xl transition-all duration-300 mx-auto">
                ...
                <h4 className="font-bold mb-2 text-blue-800 dark:text-blue-100 text-lg tracking-wide">
                  {t("litigation.process.2.title")}
                </h4>
                <p className="text-gray-700 dark:text-gray-300 text-base">
                  {t("litigation.process.2.desc")}
                </p>
              </div>
              {/* Step 4 */}
              <div className="flex-1 min-w-[240px] max-w-[280px] h-[300px] bg-white dark:bg-gray-900 rounded-2xl shadow-xl p-8 flex flex-col items-center text-center border-2 border-blue-200 dark:border-blue-800 relative hover:-translate-y-2 hover:shadow-2xl transition-all duration-300 mx-auto">
                ...
                <h4 className="font-bold mb-2 text-blue-800 dark:text-blue-100 text-lg tracking-wide">
                  {t("litigation.process.3.title")}
                </h4>
                <p className="text-gray-700 dark:text-gray-300 text-base">
                  {t("litigation.process.3.desc")}
                </p>
              </div>
            </div>
          </div>
        ...
        <section className="relative max-w-3xl mx-auto py-20 px-4 flex items-center justify-center">
          <div className="relative bg-gradient-to-br from-blue-700 via-blue-800 to-blue-900 dark:from-blue-800 dark:via-blue-900 dark:to-gray-900 rounded-3xl shadow-2xl p-12 text-center flex flex-col items-center border-4 border-white dark:border-blue-900">
            ...
            >
              {t("litigation.ctaButton")}
            </a>
            <span className="mt-6 text-blue-200 text-sm">
              {t("litigation.ctaNote")}
            </span>
          </div>
        </section>
